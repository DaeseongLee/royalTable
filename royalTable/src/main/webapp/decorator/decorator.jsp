...
<body>
		...
		<c:choose>
			<c:when test="${!empty sessionScope.loginUser}">
				<c:if test="${sessionScope.loginUser == 'admin'}">
					<div class="w3-right" style="margin-top:5px;">${sessionScope.loginUser.userName}님
				...
				<c:if test="${sessionScope.loginUser != 'admin' }">
					<div class="w3-right" style="margin-top:5px;">${sessionScope.loginUser.userName}님
						<a href="${path}/user/logout.shop" style="margin-left:15px;">로그아웃</a>
						<a href="#" style="margin-left:15px;">장바구니</a>
						<a href="${path}/user/mypage.shop?id=${sessionScope.loginUser.userId}" style="margin-left:15px;">마이페이지</a>
						<a href="#" style="margin-left:15px;">고객센터</a>
					</div>
				</c:if>
			</c:when>
			<c:when test="${empty sessionScope.loginUser}">
	...
	<br>
		...
		<div class="w3-padding-16" style="margin-left:150px; margin-right:150px;">
			<a href="${path}/user/maintest.shop" class="w3-button w3-hover-white w3-left" style="font-size:50px;font-family: 'Playball', cursive;">Royal Table</a>
...
<div class="w3-panel w3-border-top w3-border-bottom">
	<div style="margin-left:150px; margin-right:150px;padding:10px;">
		<a href="#" style="float:right-4; margin-left:200px;">고기류</a>
		<a href="#" style="float:right-3; margin-left:100px;">해물류</a>
		<a href="#" style="float:right-2; margin-left:100px;">채소류</a>
		<a href="#" style="float:right-1; margin-left:100px;">기타</a>	
	</div>
</div>
